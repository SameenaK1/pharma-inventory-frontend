...
export default function App() {
  ...
  const [aiAnalysis, setAiAnalysis] = useState('Click "Run Predictive AI" to process local demand forecasting.');
  ...
  const runAiForecast = () => {
    ...
    setTimeout(() => {
      setAiAnalysis(
        ...
        "• Upcoming changing weather trends indicate a imminent 35% surge in respiratory cases.\n" +
        "• CRITICAL: 'Amoxicillin 500mg' is currently at Low Stock (14 units). Forecasted deficit within 7 days.\n" +
        "• Recommendation: Pre-order 150 units from authorized distributor immediately to prevent disruption."
      );
      ...
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px', color: '#64748b' }}>
            ...
            <span style={{ width: '6px', height: '6px', backgroundColor: '#16a34a', borderRadius: '50%', display: 'inline-block', marginLeft: '4px' }}></span>
            <span style={{ fontSize: '12px', fontWeight: '600', color: '#16a34a' }}>Live</span>
          </div>
        </div>
        </div>
        <button style={{ backgroundColor: '#2563eb', color: '#fff', border: 'none', padding: '10px 18px', borderRadius: '10px', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', transition: '0.2s', boxShadow: '0 4px 6px -1px rgba(37, 99, 235, 0.2)' }}>
          ...
          <div style={{ backgroundColor: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '14px' }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid #f1f5f9', color: '#94a3b8', fontWeight: '600 text-transform: uppercase', fontSize: '12px' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '12px', borderBottom: '1px solid #f1f5f9' }}>
      ...
      <span style={{ fontSize: '12px', fontWeight: '700', color: '#ea580c', backgroundColor: '#fff7ed', padding: '4px 8px', borderRadius: '6px' }}>Sep 01</span>
          ...
          {/* Eye-catching Smart AI Engine Block
          <div style={{ background: 'linear-gradient(135deg, #1e1b4b, #312e81)', color: '#fff', borderRadius: '16px', padding: '24px', boxShadow: '0 10px 15px -3px rgba(30, 27, 75, 0.2)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
              <Brain size={20} style={{ color: '#a5b4fc' }} />
              <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '700', letterSpacing: '-0.01em' }}>Predictive AI Engine</h3>
            </div>
            <p style={{ margin: '0 0 20px 0', fontSize: '13px', color: '#c7d2fe', lineHeight: '1.5' }}>
              Analyzes historical demand trends, meteorological patterns, and live metrics to ensure optimal order parameters.
            </p>
            
            <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.06)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '12px', padding: '16px', fontFamily: 'monospace', fontSize: '12px', color: '#e0e7ff', minHeight: '120px', whiteSpace: 'pre-line', lineHeight: '1.6', marginBottom: '20px' }}>
              {aiAnalysis}
            </div>
            ...
            <button 
              ...
              style={{ width: '100%', backgroundColor: '#fff', color: '#312e81', border: 'none', padding: '12px', borderRadius: '10px', fontWeight: '700', fontSize: '14px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', transition: '0.2s' }}
            >
              {isAnalyzing ? 'Processing Logs...' : 'Run Predictive AI'}
            </button>
          </div> */}
  {/* NEW INTERACTIVE QUICK BILLING COUNTER */}
          {/* <div style={{ backgroundColor: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
              <div style={{ backgroundColor: '#eff6ff', color: '#2563eb', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center' }}>
                <DollarSign size={18} />
              </div>
              <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '700', color: '#0f172a' }}>Quick Retail Billing</h3>
            </div>

     
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '20px' }}>
              <div>
                <label style={{ fontSize: '12px', fontWeight: '600', color: '#64748b', display: 'block', marginBottom: '4px' }}>Select Medicine</label>
                <select style={{ width: '100%', padding: '10px', borderRadius: '8px', border: '1px solid #cbd5e1', backgroundColor: '#fff', fontSize: '14px', outline: 'none' }}>
                  <option>Paracetamol 650mg (₹20/box)</option>
                  <option>Metformin 1000mg (₹180/box)</option>
                  <option>Atorvastatin 20mg (₹340/box)</option>
                  <option>Amoxicillin 500mg (₹450/box)</option>
                </select>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <div>
                  ...
                  <input type="number" defaultValue="1" min="1" style={{ width: '100%', padding: '10px', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '14px', outline: 'none' }} />
                </div>
                <div>
                  <label style={{ fontSize: '12px', fontWeight: '600', color: '#64748b', display: 'block', marginBottom: '4px' }}>Discount (%)</label>
                  <input type="number" defaultValue="0" min="0" max="100" style={{ width: '100%', padding: '10px', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '14px', outline: 'none' }} />
                </div>
              </div>
            </div>
            <div style={{ backgroundColor: '#f8fafc', borderRadius: '12px', padding: '16px', marginBottom: '20px', border: '1px dashed #cbd5e1' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '15px', fontWeight: '700', color: '#0f172a', paddingTop: '10px', borderTop: '1px solid #e2e8f0' }}>
                <span>Total Payable:</span>
                <span style={{ color: '#2563eb' }}>₹22.40</span>
              </div>
            </div>

            <div style={{ display: 'flex', gap: '10px' }}>
              <button style={{ flex: 1, backgroundColor: '#2563eb', color: '#fff', border: 'none', padding: '12px', borderRadius: '10px', fontWeight: '700', fontSize: '14px', cursor: 'pointer', textAlign: 'center' }}>
                Print Invoice
              </button>
              <button style={{ backgroundColor: '#f1f5f9', color: '#64748b', border: 'none', padding: '12px', borderRadius: '10px', fontWeight: '600', fontSize: '14px', cursor: 'pointer' }}>
                Clear
              </button>
            </div>
          </div> */}
